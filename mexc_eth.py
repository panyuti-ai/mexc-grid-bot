"""
╔══════════════════════════════════════════════════════════════════╗
║           Jane Street v16-MEXC — ETH-USDT 啟動入口              ║
║                                                                  ║
║  交易對：ETHUSDT                                                  ║
║  資金：啟動時自動偵測帳戶 USDT 餘額 × 45%                        ║
║    ├─ 內層：70% / 60批 / 0.15% 間距                              ║
║    └─ 外層：30% / 10批 / 0.40% 間距                              ║
║                                                                  ║
...
ETH_CONFIG = {
    ...
    "ALLOCATION":   0.30,
    "CAPITAL":      1000 * 0.45,
    "INNER_CAPITAL": 1000 * 0.45 * 0.70,
    "OUTER_CAPITAL": 1000 * 0.45 * 0.90,
    ...
    "BATCHES_FILE": "mexc_batches_eth.json",
    "STATS_FILE":   "mexc_stats_eth.json",
    "METRICS_FILE": "mexc_metrics_eth.json",
...
if __name__ == "__main__":
    auto_detect_capital(ETH_CONFIG)
